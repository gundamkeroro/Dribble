...
import com.example.fengxinlin.zhuaibo.view.bucket_list.BucketListActivity;
...
public class ShotFragment extends Fragment {
    ...
    private class LikeTask extends zhuaiboTask<Void, Void, Void> {
        ...
        @Override
        protected Void doJob(Void... params) throws zhuaiboException {
            if (like) {
                zhuaibo.likeShot(id);
            } else {
                zhuaibo.unlikeShot(id);
            }
            return null;
        }
    ...
    private class CheckLikeTask extends zhuaiboTask<Void, Void, Boolean> {

        @Override
        protected Boolean doJob(Void... params) throws zhuaiboException {
            return zhuaibo.isLikingShot(shot.id);
        }
    ...
    private class LoadBucketsTask extends zhuaiboTask<Void, Void, List<String>> {

        @Override
        protected List<String> doJob(Void... params) throws zhuaiboException {
            List<Bucket> shotBuckets = zhuaibo.getShotBuckets(shot.id);
            List<Bucket> userBuckets = zhuaibo.getUserBuckets();
    ...
    private class UpdateBucketTask extends zhuaiboTask<Void, Void, Void> {
        ...
        protected Void doJob(Void... params) throws zhuaiboException {
            for (String addedId : added) {
                zhuaibo.addBucketShot(addedId, shot.id);
            }

            for (String removedId : removed) {
                zhuaibo.removeBucketShot(removedId, shot.id);
            }
            return null;
        }
