...
public class BucketListFragment extends Fragment {
    ...
    private class LoadBucketsTask extends zhuaiboTask<Void, Void, List<Bucket>> {
        ...
        @Override
        protected List<Bucket> doJob(Void... params) throws zhuaiboException {
            final int page = refresh ? 1 : adapter.getData().size() / zhuaibo.COUNT_PER_PAGE + 1;
            return userId == null
                    ? zhuaibo.getUserBuckets(page)
                    : zhuaibo.getUserBuckets(userId, page);
        }
    ...
    private class NewBucketTask extends zhuaiboTask<Void, Void, Bucket> {
        ...
        @Override
        protected Bucket doJob(Void... params) throws zhuaiboException {
            return zhuaibo.newBucket(name, description);
        }
